...
public class ALConnectionManagerProxy extends ALProxy {
    ...
    /// <summary>
    /// Set the name of the network used by the tethering mode
    /// </summary>
    /// <param name="technology"> The technology </param>
    /// <param name="name"> The name of the network as it will appear to other devices </param>

    
    
    
    
    public void setTetheringName( String technology,  String name)
    {
	Variant vtechnology;
	vtechnology = new Variant(technology);
	Variant vname;
	vname = new Variant(name);
	Variant result = call("setTetheringName" ,vtechnology, vname);
		// no return value
    }
    /// <summary>
    /// Set the passphrase used by the tethering mode
    /// </summary>
    /// <param name="technology"> The technology </param>
    /// <param name="passphrase"> The passphrase to connect to the network </param>

    
    
    
    
    public void setTetheringPassphrase( String technology,  String passphrase)
    {
	Variant vtechnology;
	vtechnology = new Variant(technology);
	Variant vpassphrase;
	vpassphrase = new Variant(passphrase);
	Variant result = call("setTetheringPassphrase" ,vtechnology, vpassphrase);
		// no return value
    }
    /// <summary>
